    ...
    AgentConfig(
        ...
        architecture=(
            ...
            },
            {
                ...
                "output": ["Obsidian inbox 条目", "可供即时反馈参考的今日上下文"],
            ...
            },
            {
                ...
                "output": ["结构化 daily note", "整理完成通知", "Git 提交候选变更"],
    ...
    AgentConfig(
        ...
        architecture=(
            ...
            },
            {
                ...
                "label": "读取个人处境",
                "kind": "tool",
                "goal": "把 personal-kb 中近期处境压缩成推荐依据。",
                "input": ["用户消息", "personal-kb/90-context", "近期 daily note 摘要"],
                "output": ["PersonalContextBundle", "处境摘要", "可回读的 source_pages"],
                "depends": ["personal-kb 路径", "上下文摘要文件"],
                "risk": ["摘要过旧", "只读摘要导致遗漏关键原文"],
            },
            {
                "id": "planner",
                "label": "LLM 规划材料检索",
            ...
            {
                "id": "evidence",
                "label": "回读 personal-kb 原文",
                "kind": "tool",
                "goal": "根据推荐问题回读少量 daily note 原文，减少只靠摘要的偏差。",
                "input": ["用户消息", "source_pages", "personal-kb daily note"],
                "output": ["personal_evidence_context", "相关原文片段"],
                "depends": ["personal-kb/10-daily", "source_pages 索引"],
